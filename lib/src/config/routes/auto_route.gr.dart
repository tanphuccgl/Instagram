...
import '../../modules/chat/chats.dart' as _i23;
...
import '../../modules/forgot_password/pages/forgot_by_email/input_token_page.dart'
    as _i28;
import '../../modules/forgot_password/pages/login_help_page.dart' as _i26;
...
import '../../modules/profile/pages/change_infomation_page.dart' as _i25;
import '../../modules/profile/pages/edit_profile_page.dart' as _i24;
import '../../modules/profile/pages/follow_page.dart' as _i22;
...
class XRouter extends _i30.RootStackRouter {
  ...
  final Map<String, _i30.PageFactory> pagesMap = {
    ...
    FollowRoute.name: (routeData) {
      ...
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData,
          child:
              _i22.FollowPage(key: args.key, initialIndex: args.initialIndex));
    },
    ChatRoute.name: (routeData) {
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i23.Chats());
    },
    ...
    ChangeInformationRoute.name: (routeData) {
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i25.ChangeInformationPage());
    },
    ForgotPasswordRoute.name: (routeData) {
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i26.ForgotPasswordPage());
    },
    AccessYourAccountRoute.name: (routeData) {
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i27.AccessYourAccountPage());
    },
    InputTokenRoute.name: (routeData) {
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i28.InputTokenPage());
    },
    CreateNewPasswordRoute.name: (routeData) {
      return _i30.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i29.CreateNewPasswordPage());
    }
  };
  ...
  List<_i30.RouteConfig> get routes => [
        ...
        _i30.RouteConfig(SignRouter.name, path: '/sign', children: [
          _i30.RouteConfig('#redirect',
              path: '',
          ...
          _i30.RouteConfig(SignUpRoute.name,
        ...
        _i30.RouteConfig(DashboardWrapperRoute.name,
            path: '/dashboard',
            children: [
              _i30.RouteConfig(DashboardRoute.name,
                  path: '',
                  ...
                  children: [
                    ...
                    _i30.RouteConfig(SearchTab.name,
                        path: 'search',
                        parent: DashboardRoute.name,
                        children: [
                          _i30.RouteConfig(SearchRoute.name,
                    ...
                    _i30.RouteConfig(VideoShowTab.name,
                        path: 'video-show',
                        parent: DashboardRoute.name,
                        children: [
                          _i30.RouteConfig(VideoShowRoute.name,
                    ...
                    _i30.RouteConfig(ActivityTab.name,
                        path: 'favorites',
                        parent: DashboardRoute.name,
                        children: [
                          _i30.RouteConfig(ActivityRoute.name,
                    ...
                    _i30.RouteConfig(ProfileTab.name,
                        path: 'profile',
                        parent: DashboardRoute.name,
                        children: [
                          _i30.RouteConfig(ProfileRoute.name,
                              path: '', parent: ProfileTab.name),
                          _i30.RouteConfig(PostProfileRoute.name,
                              path: 'post', parent: ProfileTab.name),
                          _i30.RouteConfig(FollowRoute.name,
        ...
        _i30.RouteConfig(ChatWrapperRoute.name, path: 'chat', children: [
          _i30.RouteConfig(ChatRoute.name,
        ...
        _i30.RouteConfig(EditProfileWrapperRoute.name,
            path: 'edit_profile',
            children: [
              _i30.RouteConfig(EditProfileRoute.name,
                  path: '', parent: EditProfileWrapperRoute.name),
              _i30.RouteConfig(ChangeInformationRoute.name,
                  path: '', parent: EditProfileWrapperRoute.name),
              _i30.RouteConfig('*#redirect',
                  path: '*',
        ...
        _i30.RouteConfig(ForgotPasswordWrapperRoute.name,
            path: '/dashboard',
            children: [
              _i30.RouteConfig(ForgotPasswordRoute.name,
                  path: '', parent: ForgotPasswordWrapperRoute.name),
              _i30.RouteConfig(AccessYourAccountRoute.name,
                  path: 'access_your_account',
                  parent: ForgotPasswordWrapperRoute.name),
              _i30.RouteConfig(InputTokenRoute.name,
                  path: 'input_token', parent: ForgotPasswordWrapperRoute.name),
              _i30.RouteConfig(CreateNewPasswordRoute.name,
        ...
        _i30.RouteConfig(OnboardingRoute.name, path: '/onboard'),
        _i30.RouteConfig(LoadingRoute.name, path: ''),
        _i30.RouteConfig('*#redirect',
            path: '*', redirectTo: '', fullMatch: true)
      ];
}
...
/// generated route for
/// [_i1.SignWrapperPage]
class SignRouter extends _i30.PageRouteInfo<void> {
  const SignRouter({List<_i30.PageRouteInfo>? children})
...
class DashboardWrapperRoute extends _i30.PageRouteInfo<void> {
  const DashboardWrapperRoute({List<_i30.PageRouteInfo>? children})
...
/// generated route for
/// [_i3.ChatWrapperPage]
class ChatWrapperRoute extends _i30.PageRouteInfo<void> {
  const ChatWrapperRoute({List<_i30.PageRouteInfo>? children})
...
class EditProfileWrapperRoute extends _i30.PageRouteInfo<void> {
  const EditProfileWrapperRoute({List<_i30.PageRouteInfo>? children})
...
class ForgotPasswordWrapperRoute extends _i30.PageRouteInfo<void> {
  const ForgotPasswordWrapperRoute({List<_i30.PageRouteInfo>? children})
...
class HomeTab extends _i30.PageRouteInfo<void> {
  const HomeTab({List<_i30.PageRouteInfo>? children})
...
class SearchTab extends _i30.PageRouteInfo<void> {
  const SearchTab({List<_i30.PageRouteInfo>? children})
...
class VideoShowTab extends _i30.PageRouteInfo<void> {
  const VideoShowTab({List<_i30.PageRouteInfo>? children})
...
class ActivityTab extends _i30.PageRouteInfo<void> {
  const ActivityTab({List<_i30.PageRouteInfo>? children})
...
class ProfileTab extends _i30.PageRouteInfo<void> {
  const ProfileTab({List<_i30.PageRouteInfo>? children})
...
/// generated route for
/// [_i18.VideoShowPage]
class VideoShowRoute extends _i30.PageRouteInfo<void> {
...
class PostProfileRoute extends _i30.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.FollowPage]
class FollowRoute extends _i30.PageRouteInfo<FollowRouteArgs> {
  FollowRoute({_i31.Key? key, required int initialIndex})
...
/// generated route for
/// [_i25.ChangeInformationPage]
class ChangeInformationRoute extends _i30.PageRouteInfo<void> {
...
/// generated route for
/// [_i27.AccessYourAccountPage]
class AccessYourAccountRoute extends _i30.PageRouteInfo<void> {
...
/// generated route for
/// [_i28.InputTokenPage]
class InputTokenRoute extends _i30.PageRouteInfo<void> {
...
/// generated route for
/// [_i29.CreateNewPasswordPage]
class CreateNewPasswordRoute extends _i30.PageRouteInfo<void> {
